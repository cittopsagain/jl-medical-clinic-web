export const environment = {
  production: true,
  PATIENT_RECORD_API_URL: 'https://davetolentin.ph/api/v1/patient-records',
  PATIENT_CONSULTATION_API_URL: 'https://davetolentin.ph/api/v1/patient-consultation',
  ...
  STOCK_RECEIVING_API_URL: 'http://davetolentin.ph/api/v1/stock-receiving',
  POS_RETURN_API_URL: 'http://davetolentin.ph/api/v1/stock-receiving'
};
